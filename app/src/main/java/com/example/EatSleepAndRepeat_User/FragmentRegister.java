...
public class FragmentRegister extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button btnRegister = view.findViewById(R.id.btnCreateAccount);
        EditText mail = view.findViewById(R.id.txtMailLogin);
        EditText password = view.findViewById(R.id.txtPwdRegister);
        EditText username = view.findViewById(R.id.txtUsernameRegister);
       ...
       // Button signInGoogle = view.findViewById(R.id.sign_in_button);
