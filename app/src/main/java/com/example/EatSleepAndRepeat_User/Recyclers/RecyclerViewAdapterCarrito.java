...
public class RecyclerViewAdapterCarrito extends RecyclerView.Adapter<RecyclerViewAdapterCarrito.ViewHolder> {
    private ArrayList<String> array_cart;

    public RecyclerViewAdapterCarrito(ArrayList<String> arrA){
